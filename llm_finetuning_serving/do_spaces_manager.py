...
def upload_training_data():
    ...
    files_to_upload = [
        ...
        ("splits/val.jsonl", f"{spaces_base}/splits/val.jsonl"),
        ("splits/test.jsonl", f"{spaces_base}/splits/test.jsonl"),
        ("splits/batch_config.json", f"{spaces_base}/splits/batch_config.json"),
    ]
...
def download_training_data():
    ...
    files_to_download = [
        ...
        (f"{spaces_base}/splits/val.jsonl", "splits/val.jsonl"), 
        (f"{spaces_base}/splits/test.jsonl", "splits/test.jsonl"),
        (f"{spaces_base}/splits/batch_config.json", "splits/batch_config.json"),
    ]
    ...
    print(f"✅ Download completed: {success_count}/{len(files_to_download)} files")
